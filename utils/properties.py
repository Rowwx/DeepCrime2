...
delete_training_data = {
    "name": 'delete_training_data',  # 18.01 changed juan
...
unbalance_train_data = {
    "name": 'unbalance_train_data', # 18.01 changed juan
